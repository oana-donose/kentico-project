...
[UIElement(ModuleName.ONLINEMARKETING, "ContactDataCom", false, true)]
public partial class CMSModules_ContactManagement_Pages_Tools_Contact_Tab_DataCom : CMSDataComPage, ICallbackEventHandler
{
    ...
    {
        string baseUrl = UrlResolver.ResolveUrl("~/CMSModules/ContactManagement/Pages/Tools/DataCom/SelectContact.aspx");
