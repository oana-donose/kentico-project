...
public partial class CMSModules_Cultures_Controls_UI_ResourceStringEdit : CMSAdminEditControl
{
    ...
    private void SaveTranslations()
    {
        foreach (string cultureCode in mTranslations.Keys)
        {
            ...
            if (String.IsNullOrEmpty(translation) || translation.Equals(LocalizationHelper.GetFileString(mResourceStringInfo.StringKey, cultureCode, string.Empty, false), StringComparison.InvariantCultureIgnoreCase))
            {
