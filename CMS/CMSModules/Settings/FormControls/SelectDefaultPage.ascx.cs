...
public partial class CMSModules_Settings_FormControls_SelectDefaultPage : FormEngineUserControl
{
    ...
    private void ReloadData()
    {
        ...
        {
            drpDefaultType.Items.Add(new ListItem(GetString("seodefaulttype.none"), DocumentURLProvider.DEFAULT_PAGE_NONE));
            drpDefaultType.Items.Add(new ListItem(GetString("seodefaulttype.domain"), DocumentURLProvider.DEFAULT_PAGE_DOMAIN));
            drpDefaultType.Items.Add(new ListItem(GetString("seodefaulttype.page"), DocumentURLProvider.DEFAULT_PAGE_PAGE));
            drpDefaultType.Items.Add(new ListItem(GetString("seodefaulttype.default"), DocumentURLProvider.DEFAULT_PAGE_DEFAULT));
        }
