...
[UIElement(ModuleName.ONLINEMARKETING, "account.data.com", false, true)]
public partial class CMSModules_ContactManagement_Pages_Tools_Account_Tab_DataCom : CMSDataComPage, ICallbackEventHandler
{
    ...
    {
        string baseUrl = UrlResolver.ResolveUrl("~/CMSModules/ContactManagement/Pages/Tools/DataCom/SelectCompany.aspx");
