...
public partial class CMSModules_Ecommerce_Controls_ShoppingCart_ShoppingCartOrderAddresses : ShoppingCartStep
{
    ...
    private int mLastUsedAddressId;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        mLastUsedAddressId = GetLastUsedAddressId();
    ...
    protected void LoadBillingSelectedValue()
    {
        try
        {
            ...
            else if (mLastUsedAddressId != 0)
            {
                try
                {
                    drpBillingAddr.SelectedValue = mLastUsedAddressId.ToString();
                }
                catch
                {
                }
    ...
    protected void LoadShippingSelectedValue()
    {
        try
        {
            ...
            else if (mLastUsedAddressId != 0)
            {
                try
                {
                    drpShippingAddr.SelectedValue = mLastUsedAddressId.ToString();
    ...
    protected void LoadCompanySelectedValue()
    {
        try
        {
            ...
            else if (mLastUsedAddressId != 0)
            {
                try
                {
                    drpCompanyAddress.SelectedValue = mLastUsedAddressId.ToString();
