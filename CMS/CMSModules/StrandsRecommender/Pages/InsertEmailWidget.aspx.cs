...
[CheckLicence(FeatureEnum.FullContactManagement)] // Email recommendations needs Contact Management in order to work, so inserting recommendation to the email is not permitted if Contact Management is not available
