...
public partial class CMSModules_PortalEngine_UI_WebParts_WebPartProperties_nested : CMSWebPartPropertiesPage
{
    ...
    private bool DataSourceChanged
    {
        get
        {
            return selWebPart.DropDownListControl.UniqueID.EqualsCSafe(CMSHttpContext.Current.Request.Form[postEventSourceID], true);
        }
    }
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        switch (NestedKey.ToLowerInvariant())
        {
            case "datasource":
