...
public partial class CMSModules_Ecommerce_Controls_ShoppingCart_ShoppingCartPaymentShipping : ShoppingCartStep
{
    ...
    private CustomerPreferences mPreferences = CustomerPreferences.Unknown;
    ...
    protected void SelectPaymentOption()
    {
        try
        {
            ...
            {
                if (mPreferences.PaymentOptionID.HasValue)
                {
                    selectPayment.SelectedID = mPreferences.PaymentOptionID.Value;
                }
            }
        }
        catch
